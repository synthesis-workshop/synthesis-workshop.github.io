    ...
    <>
      <section id="about" className="about">
        <div className="container">
          ...
          <h3 className="card-title mt-3">Who We Are</h3>
          <div className="row">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text" style={{ textAlign: "justify" }}>
                    ...
                    currently works at Eurofins Villapharma in Spain, as Head of
                    Scale-up Laboratory and Business Subunit and he serves on
          ...
          <div className="row mt-3">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text" style={{ textAlign: "justify" }}>
                    ...
                    Universität Regensburg (Germany), working on visible-light
                    carboxylation reactions with Prof. Burkhard König. After a
                    year in industry placement at the pRED division of
                    Hoffmann-La Roche in Basel, working on malignancies
                    treatment and neurodegenerative diseases, he received his
                    PhD under the guidance of the Prof. Frank Glorius
                    (Universität Münster, Germany), conducting research on
                    visible light catalyzed cross-couplings, energy-transfer
                    photocatalytic cycloadditions and NHCs on surfaces. Peter is
                    currently postdoctoral associate and DFG Walter Benjamin
                    fellow at Weill Cornell Medicine (New York, USA), working at
                    the interface between photocatalysis and chemical biology.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-3 d-flex align-items-center justify-content-center">
              <img
                style={{ width: "300px" }}
                src="img/peter_bellotti_headshot.jpg"
                className="img-fluid"
                alt=""
              />
            </div>
...
<div className="row mt-3">
 	...
 	<div className="row mt-3">
            ...
            <div className="col-lg-3 d-flex align-items-center justify-content-center">
              <img
                style={{ width: "300px" }}
                src="img/Kathleen_Cheasty_headshot.jpeg"
                className="img-fluid"
                alt=""
              />
            </div>
 ...
 {/* !!!Start copying here!!! */}
	...
	<div className="row mt-3">
            <div className="col-lg-9 pt-4 pt-lg-0">
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title">Editorial Board: Aidan Looby</h4>
                  <p className="card-text" style={{ textAlign: "justify" }}>
                    Aidan is from King of Prussia, Pennsylvania - a suburb of
            ...
            <div className="col-lg-3 d-flex align-items-center justify-content-center">
              <img
                style={{ width: "300px" }}
                src="img/Aidan_Looby_headshot.JPEG"
                className="img-fluid"
                alt=""
              />
            </div>
