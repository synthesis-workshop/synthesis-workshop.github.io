...
export default () => {
    return (
        <>
            <section id="episode-list" class="episode-list">
                <div class="container">
                    ...
                    <div class="row d-flex align-items-center justify-content-center">
                        {/* <div class="col-lg-4 d-flex align-items-center justify-content-center">
                            <img width="100%" src="img/about.svg" class="img-fluid" alt="" />
                        </div> */}
                        <div class="col-lg-10">
                            <table class="table">
                                <thead>
                                        ...
                                        let color = video.type === "total-synthesis" ? BLUE
                                            : video.type === "research-spotlight" ? GREEN
                                                : video.type === "named-reactions" ? RED
                                                    : YELLOW
                                        let type = video.type === "total-synthesis" ? "Total Synthesis"
                                            : video.type === "research-spotlight" ? "Research Spotlight"
                                                : video.type === "named-reactions" ? "Named Reaction"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a
                                                        ...
                                                        href={YOUTUBE_WATCH_URL.replace(VID_ID, video.videoId)}
                                                    >
                                                        {video.displayTitle}
                                                    </a>
                                                </td>
