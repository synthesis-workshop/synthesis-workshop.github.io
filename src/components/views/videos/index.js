      ...
      <section id="videos" className="videos">
        <div className="container">
          ...
          <div className="row">
            ...
            <div
              className="col-lg-12 col-md-12 d-flex align-items-stretch justify-content-center"
              data-aos="zoom-in"
              data-aos-delay="100"
            >
              <ReactPlayer
            ...
            <div
              className="mt-3 col-lg-12 col-md-12 d-flex align-items-stretch justify-content-center"
              data-aos="zoom-in"
              data-aos-delay="100"
            >
              <strong>
                Episode {allVideos[0].episodeNumber}:{" "}
                {allVideos[0].displayTitle}
              </strong>
            </div>
            ...
            {videos["total-synthesis"].length > 0 && (
              <>
                <h4 className="pt-5" style={{ color: BLUE }}>
                  Total Synthesis Episodes ({videos["total-synthesis"].length})
                </h4>
                <div
                  className="col-lg-12 col-md-12 d-flex align-items-stretch"
                  data-aos="zoom-in"
                  data-aos-delay="100"
                >
            ...
            {videos["named-reactions"].length > 0 && (
              <>
                <h4 className="pt-5" style={{ color: RED }}>
                  Named Reaction Episodes ({videos["named-reactions"].length})
                </h4>
                <div
                  className="col-lg-12 col-md-12 d-flex align-items-stretch"
                  data-aos="zoom-in"
            ...
            {videos["research-spotlight"].length > 0 && (
              <>
                <h4 className="pt-5" style={{ color: GREEN }}>
                  Research Spotlight Episodes (
                  {videos["research-spotlight"].length})
                </h4>
                <div
                  className="col-lg-12 col-md-12 d-flex align-items-stretch"
                  data-aos="zoom-in"
            ...
            {videos["culture-of-chemistry"].length > 0 && (
              <>
                <h4 className="pt-5" style={{ color: YELLOW }}>
                  Culture of Chemistry Episodes (
                  {videos["culture-of-chemistry"].length})
                </h4>
                <div
                  className="col-lg-12 col-md-12 d-flex align-items-stretch"
                  data-aos="zoom-in"
                    ...
                    {allVideos.map((video) => {
                      ...
                      return (
                        <VideoThumbnail
                          ...
                          title={video.displayTitle}
                          episodeNumber={video.episodeNumber}
                          link={YOUTUBE_WATCH_URL.replace(
                            VID_ID,
                            video.videoId
                          )}
                          url={YOUTUBE_THUMBNAIL_URL.replace(
